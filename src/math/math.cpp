...
namespace mrs_lib
{
  ...
  double probit(const double quantile)
  {
    ...
    constexpr double a[4] = {2.50662823884, -18.61500062529, 41.39119773534, -25.44106049637};

    // polynomial coefficients of the denominator for the rational polynomial approximation in the range (0.08; 0.92)
    constexpr double b[4] = {-8.47351093090, 23.08336743743, -21.06224101826, 3.13082909833};

    // polynomial coefficients of the logarithmical approximation in the range (0; 0.08) U (0.92; 1)
    constexpr double c[9] = {0.3374754822726147, 0.9761690190917186, 0.1607979714918209, 0.0276438810333863, 0.0038405729373609,
