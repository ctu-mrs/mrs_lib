...
namespace mrs_lib::MRS_LIB_INTERNAL_INLINE_API_V1 v1
{
  ...
  VisualObject::VisualObject(const mrs_lib::geometry::Cylinder& cylinder, const double r, const double g, const double b, const double a,
                             const rclcpp::Duration& timeout, const bool filled, const bool capped, const unsigned long& id,
                             const rclcpp::Node::SharedPtr& node, const int num_sides)
      : id_(id), node_(node)
  {
    if (capped)
    {
  ...
  VisualObject::VisualObject(const mrs_lib::geometry::Cone& cone, const double r, const double g, const double b, const double a,
                             const rclcpp::Duration& timeout, const bool filled, const bool capped, const unsigned long& id,
                             const rclcpp::Node::SharedPtr& node, const int num_sides)
      : id_(id), node_(node)
  {
