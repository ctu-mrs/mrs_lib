...
template std::optional<test_t::Ptr> mrs_lib::Transformer::transform<test_t::Ptr>(const mrs_lib::TransformStamped& to_frame, const test_t::Ptr& what);
template std::optional<test_t::ConstPtr> mrs_lib::Transformer::transform<test_t::ConstPtr>(const mrs_lib::TransformStamped& to_frame, const test_t::ConstPtr& what);
template std::optional<test_t> mrs_lib::Transformer::transformSingle<test_t>(const std::string& to_frame, const test_t& what);
template std::optional<test_t::Ptr> mrs_lib::Transformer::transformSingle<test_t::Ptr>(const std::string& to_frame, const test_t::Ptr& what);
template std::optional<test_t::ConstPtr> mrs_lib::Transformer::transformSingle<test_t::ConstPtr>(const std::string& to_frame, const test_t::ConstPtr& what);
