  ...
  namespace quadratic_throttle_model
  {
    ...
    struct motor_params_t
    {
      ...
      motor_params_t(int n_motors, double a, double b)
        : n_motors(n_motors), a(a), b(b), c(0), type(type_t::legacy), an(0), bn(0), cn(0)
      {}
    ...
    double inline forceToThrottle(const motor_params_t& motor_params, const double force)
    {
      if (motor_params.type == motor_params_t::type_t::linear || motor_params.a < 1e-6)
      {
        ...
        {
          ROS_ERROR_THROTTLE(1.0, "forceToThrottle: The N*b parameter is too small!");
          return 0.0;
        }
      ...
      else if (motor_params.type == motor_params_t::type_t::full_quadratic)
      {
        ...
        if (discriminant < 0.0)
        {
          ROS_ERROR_THROTTLE(1.0, "forceToThrottle: Discriminant of throttle solution is negative, setting zero!");
          discriminant = 0;
        }
