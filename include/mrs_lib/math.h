...
namespace mrs_lib
{
   ...
   * (see page 68 of Glasserman, Paul, "Monte Carlo Methods in Financial Engineering. Stochastic Modelling and Applied Probability", 2003,
   * doi:10.1007/978-0-387-21617-1, available at https://sci-hub.se/10.1007/978-0-387-21617-1).
   *
   * \param quantile the probability that a realization of a random variable with a standard normal dostribution is equal or less than the returned value (see
