...
namespace mrs_lib
{
  ...
  public:
     ...
     * \param line_variance  Variance defining the uncertainty of the measured state in the direction perpendicular to the measurement line. The uncertainty in
     * the parallel direciton is assumed to be infinite for this case of DKF. \return               The state and covariance after the correction update.
     */
    virtual std::enable_if_t<((n > 3) || (n == Eigen::Dynamic)), statecov_t> correctLine(const statecov_t& sc, const pt3_t& line_origin,
                                                                                         const vec3_t& line_direction, const double line_variance) const
    {
     ...
     * \param plane_variance Variance defining the uncertainty of the measured state in the direction perpendicular to the measurement plane. The uncertainty in
     * the span of the plane is assumed to be infinite for this case of DKF. \return               The state and covariance after the correction update.
     */
    virtual std::enable_if_t<((n > 3) || (n == Eigen::Dynamic)), statecov_t> correctPlane(const statecov_t& sc, const pt3_t& plane_origin,
                                                                                          const vec3_t& plane_normal, const double plane_variance) const
    {
