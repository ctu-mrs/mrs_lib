...
namespace mrs_lib
{
  ...
  public:
     ...
     * columns and the size of the loaded array). \param cols  Expected number of columns of the matrix (negative value indicates that the number of columns is
     * to be deduced from the specified number of rows and the size of the loaded array). \return      true if loaded successfully, false otherwise.
     */
    template <typename T>
     ...
     * \param default_value This value will be used if the parameter name is not found in the rosparam server.
     * \param mat           Reference to the variable to which the parameter value will be stored (such as a class member variable).
     * \param rows          Expected number of rows of the matrix (negative value indicates that the number of rows is to be deduced from the specified number
     * of columns and the size of the loaded array). \param cols          Expected number of columns of the matrix (negative value indicates that the number of
     * columns is to be deduced from the specified number of rows and the size of the loaded array). \return              true if the parameter was loaded from
     * \p rosparam, false if the default value was used.
     */
    template <typename T, typename Derived>
     ...
     * \param rows  Expected number of rows of the matrix (negative value indicates that the number of rows is to be deduced from the specified number of
     * columns and the size of the loaded array). \param cols  Expected number of columns of the matrix (negative value indicates that the number of columns is
     * to be deduced from the specified number of rows and the size of the loaded array). \return      The loaded parameter value.
     */
    template <typename T = double>
     ...
     *
     * If the dimensions of the loaded matrices do not match the specified number of rows and columns, the loading process is unsuccessful
     * (loaded_successfully() will return false). If the parameter with the specified name is not found on the \c rosparam server (e.g. because it is not
     * specified in the launchfile or yaml config file), the loading process is unsuccessful. Using this method, the parameter can only be loaded once using the
     * same ParamLoader instance without error.
     *
     * \param name  Name of the parameter in the rosparam server.
     * \param mat   Reference to the variable to which the parameter value will be stored (such as a class member variable).
     *
