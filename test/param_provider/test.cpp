...
class TestParamProvider : public ::testing::Test {
...
protected:
  ...
  void initialize(const rclcpp::NodeOptions& node_options = rclcpp::NodeOptions()) {
    ...
    main_thread_ = std::thread(&TestParamProvider::spin, this);
  }
...
void TestParamProvider::timerCallback(void) {
...
void TestParamProvider::do_test(const bool use_threadtimer) {
  ...
  std::function<void()> callback_fcn = std::bind(&TestParamProvider::timerCallback, this);
...
/* TEST_F(TestParamProvider, thread_timer) //{ */
...
/* TEST_F(TestParamProvider, ros_timer) //{ */
